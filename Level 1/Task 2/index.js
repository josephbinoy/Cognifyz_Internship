...
var index=0;
var colours=['FF0000','FF8700','A7F05A','1C706B','89FFFA','8147B2','030D9B','F7FF00'] //colours array

function changeColor(){   //fn to change color on click
...
const newShade = (hexColor, magnitude) => {  //calculate suitable text color for each button color. ex: you dont want white on white
...
function getAlert(){
    ...
    if(hours<6)
        ...
        alert("Good Night. Time is "+hours+": "+min+" right now!");
